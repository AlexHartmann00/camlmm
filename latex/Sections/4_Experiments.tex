...
Given the nature of the data and the task of predicting user sentiment (VADER NA scores) over time based on covariateg an LMM provides:
\begin{itemize}
    \item A means of handling the hierarchical structure of the data (users, repeated observations).
    \item Robust handling of correlated observations and unexplained differences in individual baseline outcome levels.
\end{itemize}
